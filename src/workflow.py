...
class Workflow:
    ...
    def _extract_tools_step(self,state:ResearchState)->Dict[str,any]:
        ...
        messages = [
            SystemMessage(
                content=self.prompts.TOOL_EXTRACTION_SYSTEM
            ),
            HumanMessage(
                content=self.prompts.tool_extraction_user(state.query,all_contents)
            )
        ]
        ...
        try:
            ...
            return {"Extracted Tools": tool_names}
        except Exception as e:
            print("extract tools error", e)
    ...
    def _analyze_company_content(self,company_name:str,content:str)->CompanyAnalysis:
        ...
        try:
            ...
            print("Analyze company content error",e)
